 ...
 * @author sergi
 */
@WebServlet(name = "PdfSoloPreguntas", urlPatterns = {"/PdfSoloPreguntas"})
public class PdfSoloPreguntas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        String a=request.getParameter("idpdfpreguntas");
        String filePath=a;
